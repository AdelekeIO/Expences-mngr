          ...
          <b-card-group>
            ...
            <b-card no-body class="text-white bg-primary py-5 d-md-down-none" style="width:44%">
              <b-card-body class="text-center">
                <div>
                  <h2>Sign up</h2>
                  <p>expences_mngr Is an application that models real life expences_mngr where by users can create expences_mngr, add item to it, manage and delete items in the expences_mngr and even the expences_mngr.</p>
  ...
  methods:{
    processLogin(){
      ...
      return;
        ...
        axios.post('http://idealhealthcare.wilsonjohnsonlawgroup.org/auth/login?',fd,config)
        .then(res =>{
